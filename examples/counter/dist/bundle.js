...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createDispatch = __webpack_require__(160);

	var _createDispatch2 = _interopRequireDefault(_createDispatch);

	var _configureModel = __webpack_require__(161);

	var _configureModel2 = _interopRequireDefault(_configureModel);
	...
	var model = (0, _configureModel2.default)({
	  // Initial Store
	  counter: 5
	});

	var dispatch = (0, _createDispatch2.default)(model.present);

	model.subscribe(function (state) {
	  console.log('View received new state', state);
	  (0, _reactDom.render)(_react2.default.createElement(_App2.default, { state: state, dispatch: dispatch }), document.getElementById('root'));
	});
...
/***/ function(module, exports) {
	...
	var createDisptach = function createDisptach(present) {
	...
	exports.default = createDisptach;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.__esModule = true;
	exports.default = configureModel;

	var _container = __webpack_require__(162);

	var _container2 = _interopRequireDefault(_container);

	var _nap = __webpack_require__(163);

	var _nap2 = _interopRequireDefault(_nap);

	var _samDevtools = __webpack_require__(164);

	var _samDevtoolsMonitor = __webpack_require__(168);

	var _samDevtoolsMonitor2 = _interopRequireDefault(_samDevtoolsMonitor);

	var _sam = __webpack_require__(169);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	// Monitor

	(0, _samDevtools.subscribe)(_samDevtoolsMonitor2.default);
	...
	function configureModel(initialStore) {
	  var model = (0, _sam.createModel)(_container2.default, state, _nap2.default, initialStore, _samDevtools.instrument);
	  if (false) {
	    module.hot.accept('./container', function (_) {
	      return model.replaceContainer((0, _samDevtools.liftContainer)(require('./container').default));
	    });
	    module.hot.accept('./nap', function (_) {
	      return model.replaceNap((0, _samDevtools.liftNap)(require('./nap').default));
	    });
	  }
	  return model;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.liftContainer = liftContainer;
	exports.liftNap = liftNap;
	...
	var loadSnapshot = function loadSnapshot(i) {
	  return model.replaceStore(getSnapshot(i));
	};

	var publish = function publish(_) {
	  return listeners.forEach(function (listener) {
	    return listener(snapshots, loadSnapshot);
	  });
	};

	function liftContainer(container) {
	  return function (store, dataset) {
	    // check for infinite loop in nap
	    if (dataset['@@napLoop']) {
	      var _newStore = { '@@napLoop': true };
	      snapshots.push({
	        dataset: _extends({}, dataset),
	        store: {}
	      });
	      publish();
	      return _newStore;
	    }
	    var newStore = container(store, dataset);
	    snapshots.push({
	      dataset: _extends({}, dataset),
	...
	var getSnapshot = function getSnapshot(index) {
	  snapshots = snapshots.slice(0, index + 1);
	  publish();
	  return _extends({}, snapshots[index].store);
	};

	var fromNap = function fromNap(snapshot) {
	  return snapshot.dataset['@@nap'] !== undefined;
	};

	function liftNap(nap) {
	  return function (currentState) {
	    return function (present) {
	      return nap(currentState)(function (dataset) {
	        // check for infinite loop in nap
	        ...
	        var tooManyPresentsFromNAP = snapshots.slice(-MAX_PRESENTS_FROM_NAP).filter(fromNap).length == MAX_PRESENTS_FROM_NAP;
	        if (tooManyPresentsFromNAP) {
	          return present({ '@@napLoop': 'too many present()s from NAP' });
	        }

	        var secondLastSnapshot = snapshots[snapshots.length - 2];
	        var ineffectiveNAP = fromNap(lastSnapshot) && fromNap(secondLastSnapshot) && (0, _deepEqual2.default)(lastSnapshot.store, secondLastSnapshot.store);
	        if (ineffectiveNAP) {
	          return present({ '@@napLoop': 'last present() from NAP didn\'t change the store' });
	        }
	        var liftedDataset = _extends({}, dataset, {
	          '@@nap': true
	        });
	...
	function instrument(createModel) {
	  // This reference can't change otherwise the View will get lost
	  return function (container, state, nap, initialStore, enhancer) {
...
/***/ function(module, exports) {
	...
	var filterKeys = function filterKeys(store) {
	  var output = _extends({}, store);
	  keys.forEach(function (k) {
	    return delete output[k];
	  });
	  return output;
	};

	var getNode = function getNode(_) {
	  var node = document.getElementById('SAMTimeTravelUI');
	  if (!node) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createModel = __webpack_require__(170);

	Object.defineProperty(exports, 'createModel', {
	  enumerable: true,
	  get: function get() {
	    return _interopRequireDefault(_createModel).default;
	  }
	});
	...
	var App = function App(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      state.counter,
	      ' ',
	      state.launchImminent ? '(watch out! will launch soon!)' : ''
	    ),
	    _react2.default.createElement(
	      'h3',
	      null,
	      state.hasLaunched ? 'LAUNCHED' : ''
	    ),
	    _react2.default.createElement(
	      'button',
	      { onClick: inc },
